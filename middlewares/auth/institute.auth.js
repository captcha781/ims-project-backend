...
const instituteTokenModel = require("../../models/instituteAdminToken");
const instituteModel = require("../../models/instituteAdmin");

const instituteAuthMiddleware = async (req, res, next) => {
  try {
    ...
    let admin = await instituteModel.findById(decodedToken.adminId);
...
module.exports = instituteAuthMiddleware;
